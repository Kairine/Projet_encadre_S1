...
echo "<html>" > $2
echo "<head><title>FINAL TABLE</title><meta charset=\"UTF-8\" /></head>" >> $2
echo "<body>" >> $2
...
for fichier in $(ls $1)
	...
	echo "<tr>
			<td align = "center" colspan=\"3\"><a target='_blank' href='./corpus-$comtab.html'>Corpus N° $comtab</a></td>
			<td align = "center" colspan=\"3\"><a target='_blank' href='./corpus_ctx-$comtab.html'>Contexte N° $comtab</a></td>
			<td align = "center" colspan=\"3\"><a target='_blank' href='./corpus-$comtab-index.html'>Corpus index N° $comtab</a></td>
			<td align = "center" colspan=\"3\"><a target='_blank' href='./corpus_ctx-$comtab-index.html'>Contexte index N° $comtab</a></td>
		</tr>" >> $2
	echo "</table>" >> $2
